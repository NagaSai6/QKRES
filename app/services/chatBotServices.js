...
const markMessageRead = require("../services/markMessagesService")
const sendTypingOn = require("../services/sendTypinService")
const getFacebookUsername = require("../services/fbusernameService")
...
let sendMessageWelcomeNewUser = (sender_psid) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            //send text message
            let response1 = {
                "text": `Hi ${username}! Welcome to QkRes,A place to serve your needs.`
            };
...
let showMechanicals = (sender_psid) => {
    return new Promise(async (resolve, reject) => {
        try {
