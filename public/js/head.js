...
function initAdmin(socket) {
  ...
  function generateMarkup(orders) {
    return orders.map(function (order) {
      return "\n\n      <hr style=\"height:2px;width:100%;background:yellow;\" >\n      <div class=\"my-2\"> <b> Order Placed at : </b>\n      ".concat(moment__WEBPACK_IMPORTED_MODULE_1___default()(order.createdAt).format('MMMM Do YYYY hh:mm A'), "\n      </div>\n\n    \n\n               <p class=\"my-2\"> <b>Order Id:</b> ").concat(order._id, " </p>\n<hr>\n\n                    <div class=\"orderedItems my-3\"> <b>Ordered Items :</b>").concat(renderItems(order.items), "</div>\n            \n<hr>      \n              <p class=\"mb-2\">Name : <b>  ").concat(order.customerId.google ? order.customerId.google.customerName : order.customerId.local.customerName, "   </b></p>\n       \n              <b class=\"mb-3\">Phone : <i>  ").concat(order.phone, " </i> </b>\n               <b class=\"mb-3\">Addresss : <i>  ").concat(order.address, " </i> </b>\n\n               <b class=\"mb-3\">Addresss : <i>  ").concat(order.pincode, " </i> </b>\n\n                \n                    <div class=\"inline-block relative w-64\">\n                        <form action=\"/admin/order/status\" method=\"POST\">\n                            <div class=\"form-group\">\n                            <input class=\"form-control input-lg\" type=\"hidden\" name=\"orderId\" value=\"").concat(order._id, "\">\n                            </div>\n                            <select name=\"status\" onchange=\"this.form.submit()\">\n                                <option value=\"order_placed\"\n                                    ").concat(order.status === 'order_placed' ? 'selected' : '', ">\n                                    Placed</option>\n                                <option value=\"confirmed\" ").concat(order.status === 'confirmed' ? 'selected' : '', ">\n                                    Confirmed</option>\n                                <option value=\"prepared\" ").concat(order.status === 'prepared' ? 'selected' : '', ">\n                                    Prepared</option>\n                                <option value=\"delivered\" ").concat(order.status === 'delivered' ? 'selected' : '', ">\n                                    Delivered\n                                </option>\n                                <option value=\"completed\" ").concat(order.status === 'completed' ? 'selected' : '', ">\n                                    Completed\n                                </option>\n                            </select>\n                        </form>\n                   \n                    </div>\n                    <hr style=\"height:2px;width:100%;background:yellow;\" >   \n\n                    \n               \n                    \n         \n        ");
    }).join('');
  } // Socket
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _admin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./admin */ "./Resources/admin.js");
...
var hiddenPut = document.querySelector("#hiddenInput");
var order = hiddenPut ? hiddenPut.value : null; // console.log(order);
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_2___default()(order.updatedAt).format("MMM Do YY hh:mm A");
...
if (adminArea.includes("admin")) {
  Object(_admin__WEBPACK_IMPORTED_MODULE_0__["initAdmin"])(socket);
...
/***/ 0:
/*!*******************************************************!*\
  !*** multi ./Resources/main.js ./Resources/main.scss ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\Users\Naga Sai\Desktop\WebOps\Projects\Qkres\Resources\main.js */"./Resources/main.js");
module.exports = __webpack_require__(/*! C:\Users\Naga Sai\Desktop\WebOps\Projects\Qkres\Resources\main.scss */"./Resources/main.scss");
